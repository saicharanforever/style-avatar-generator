...
const SparklesText: React.FC<SparklesTextProps> = ({
  ...
  return <div className={cn("text-4xl md:text-6xl font-bold", className)} {...props} style={{
    ...
    "--sparkles-second-color": `${colors.second}`
      ...
      <span className="relative inline-block">
        ...
        <strong className="relative z-10 text-center block leading-tight font-anton">
          <span className="block text-6xl mx-0 my-0 py-0">Give <span className="text-black">Life</span> to</span>
...
const Sparkle: React.FC<Sparkle> = ({
  ...
  return <motion.svg key={id} className="pointer-events-none absolute z-20" initial={{
    opacity: 0,
    left: x,
    top: y
  }} animate={{
