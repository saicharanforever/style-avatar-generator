...
const PricingCard = ({ label, monthlyPrice, description, cta, background, BGComponent, onCtaClick }: PricingCardProps) => {
  return (
    <motion.div
      whileHover="hover"
...
export const SquishyPricing: React.FC<SquishyPricingProps> = ({ plans }) => {
      ...
      <div className="mx-auto flex w-fit flex-wrap justify-center gap-4">
        {plans.map((plan, index) => (
          <PricingCard
            ...
            BGComponent={bgComponents[index % bgComponents.length]}
