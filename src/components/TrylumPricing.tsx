...
function TrylumPricing() {
  ...
  return <section className="relative py-32 bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 text-slate-900 overflow-hidden min-h-screen">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div className="absolute inset-0 bg-gradient-to-br from-blue-500/[0.08] via-purple-500/[0.05] to-rose-500/[0.08]" animate={{
        ...
        {/* Moving orbs */}
        <motion.div className="absolute top-1/4 left-1/6 w-80 h-80 bg-blue-400/10 rounded-full blur-3xl" animate={{
        x: [0, 150, 0],
        y: [0, 80, 0],
        scale: [1, 1.3, 1]
      }} transition={{
        ...
        <motion.div className="absolute bottom-1/4 right-1/6 w-64 h-64 bg-purple-400/10 rounded-full blur-3xl" animate={{
        x: [0, -120, 0],
        y: [0, -60, 0],
        scale: [1, 1.2, 1]
      }} transition={{
        ...
        {/* Floating particles */}
        {[...Array(20)].map((_, i) => <motion.div key={i} className="absolute w-1 h-1 bg-blue-500/30 rounded-full" style={{
      ...
      <motion.div ref={containerRef} className="relative z-10 max-w-6xl mx-auto px-6" initial={{
      opacity: 0
    }} whileInView={{
      opacity: 1
    }} viewport={{
      ...
      delayChildren: 0.3
        ...
        duration: 0.8
          ...
          <motion.div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/80 border border-blue-200 backdrop-blur-sm mb-6 shadow-lg" whileHover={{
          scale: 1.05,
          ...
          <motion.h2 className="text-4xl sm:text-6xl md:text-7xl font-bold mb-8 tracking-tight" initial={{
          opacity: 0,
          y: 60
        }} whileInView={{
          opacity: 1,
          ...
          duration: 0.8
            ...
            <br />
            <motion.span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-purple-600 to-rose-600" animate={{
          ...
          <motion.p className="text-xl sm:text-2xl text-slate-600 max-w-4xl mx-auto leading-relaxed mb-12" initial={{
          opacity: 0,
          y: 60
        }} whileInView={{
          opacity: 1,
        ...
        {/* Pricing Cards */}
        <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20 max-w-5xl mx-auto" initial={{
        opacity: 0
      }} whileInView={{
        opacity: 1
      }} viewport={{
        ...
        delayChildren: 0.3
          ...
          {pricingTiers.map((plan, index) => <motion.div key={plan.name} className="relative" initial={{
          opacity: 0,
          y: 60
        }} whileInView={{
          opacity: 1,
        ...
        duration: 0.8
          ...
          <div className="relative bg-gradient-to-br from-green-50 to-green-100 backdrop-blur-xl rounded-3xl border border-green-200 p-8 md:p-12 overflow-hidden group max-w-4xl mx-auto shadow-xl">
            <motion.div className="absolute inset-0 bg-gradient-to-br from-green-500/[0.08] via-emerald-500/[0.05] to-teal-500/[0.08] rounded-3xl" animate={{
            backgroundPosition: ['0% 0%', '100% 100%', '0% 0%']
          }} transition={{
            duration: 15,
            repeat: Infinity,
            ...
            <div className="relative z-10">
              <motion.div className="w-16 h-16 rounded-full bg-green-500 flex items-center justify-center mx-auto mb-6 shadow-lg" whileHover={{
              scale: 1.1,
              rotate: 360
            }} transition={{
              duration: 0.6
              ...
              <p className="text-xl text-slate-700 mb-8 leading-relaxed">Get personalized recommendations and answers to all your questions about Trylum's fashion technology.</p>
              ...
              scale: 0.95
                ...
                <Button onClick={handleWhatsAppClick} className="relative group overflow-hidden bg-green-500 hover:bg-green-600 text-white font-medium py-4 px-8 rounded-xl transition-all shadow-lg">
