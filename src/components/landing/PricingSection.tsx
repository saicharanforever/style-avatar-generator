          ...
          {pricingPlans.map(plan => (
            <div 
              ...
              className={`glass-card p-6 rounded-lg border ${
                plan.popular 
                  ? theme === 'dark' ? 'border-gold' : 'border-[#D4AF37]' 
                  : theme === 'dark' ? 'border-white/10' : 'border-[#8E6BFF]/20'
              } transition-all hover:translate-y-[-5px] relative ${
                theme === 'light' ? 'bg-[#666475] text-white' : ''
              }`}
            >
              {plan.popular && (
              ...
              <div className="flex items-end gap-1 mb-4">
                <span className={
                  theme === 'dark' ? 'text-3xl font-bold text-white' : 'text-3xl font-bold text-white'
                }>
                  {plan.price}
                </span>
                <span className={
                  theme === 'dark' ? 'text-white/70 pb-1' : 'text-white/70 pb-1'
                }></span>
              </div>
              ...
              <div className={`flex items-center gap-2 ${
                ...
                <span className={
                  theme === 'dark' ? 'font-bold text-white' : 'font-bold text-white'
                }>
                ...
                <Button 
                  className={`flex-1 ${
                    theme === 'dark' 
                      ...
                      : 'bg-gradient-to-r from-[#7956E5] to-[#9D7DEB] text-white hover:from-[#6A47D6] hover:to-[#8E6EE2]'
