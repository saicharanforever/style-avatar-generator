...
const BeforeAfterCarousel = () => {
  ...
  return <div className="w-full mx-auto max-w-4xl py-0">
      ...
      align: "center"
        ...
        <CarouselContent>
          {imageSlides.map((slide, index) => <CarouselItem key={index} className="md:basis-full">
              <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 p-1">
                ...
                <div className="glass-card p-4 rounded-lg">
                  ...
                  <div className="bg-navy-dark/50 rounded-lg p-4 h-64 w-64 flex items-center justify-center overflow-hidden">
                    <img src={slide.before} alt={`Clothing item ${index + 1} before`} className="h-full w-full object-cover" onError={e => {
                ...
                <div className="glass-card p-4 rounded-lg">
                  ...
                  <div className="bg-navy-dark/50 rounded-lg p-4 h-64 w-64 flex items-center justify-center overflow-hidden">
                    <img src={slide.after} alt={`Clothing item ${index + 1} on model`} className="h-full w-full object-cover" onError={e => {
      ...
      <div className="flex justify-center mt-4 gap-2">
        {imageSlides.map((_, index) => <button key={index} className={`h-2 w-2 rounded-full transition-all ${currentSlide === index ? "bg-gold w-4" : "bg-white/30"}`} onClick={() => {
        api?.scrollTo(index);
        setAutoPlay(false);
