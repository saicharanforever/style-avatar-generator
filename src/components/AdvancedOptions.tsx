...
const AdvancedOptions = ({
  ...
  const getToggleGroupStyle = (isSelected: boolean) => {
    ...
    return theme === 'light' 
      ? 'border border-purple-200 bg-white hover:bg-purple-50 hover:border-purple-300 text-purple-700 hover:scale-105 transition-all duration-200'
      : 'border border-blue-800 bg-navy-dark hover:bg-blue-900 hover:border-blue-600 text-white hover:scale-105 transition-all duration-200';
  };
  ...
  return (
    <div className="w-full max-w-md mx-auto mb-8">
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <CollapsibleTrigger className={`w-full flex items-center justify-between p-4 rounded-lg border ${
          theme === 'light' 
            ? 'bg-purple-50 border-purple-200 hover:bg-purple-100' 
            : 'bg-navy-dark border-blue-800 hover:bg-blue-900'
        } transition-all duration-200 hover:scale-102`}>
          <h2 className={`font-bold text-2xl ${getSectionTitle()}`}>
            Advanced Options
          </h2>
        ...
        <CollapsibleContent className="mt-4">
          <div className="space-y-6">
            {/* Size and Fit - Stacked vertically */}
