...
const EthnicitySelector = ({ selectedEthnicity, onEthnicitySelect }: EthnicitySelectorProps) => {
  return (
    <div className="w-full max-w-md mx-auto mb-8">
      <h2 className="text-5xl font-bold text-yellow-300 mb-4">Ethnicity</h2>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          <Globe className={`h-12 w-12 ${
            selectedEthnicity === 'american' ? 'text-white' : 'text-blue-500'
          }`} />
        ...
        >
          <Map className={`h-12 w-12 ${
            selectedEthnicity === 'indian' ? 'text-white' : 'text-blue-500'
          }`} />
